...
The data being used in this project is sourced from the Behavioral Risk Factor Surveillance System (BRFSS) which is a telephone based survey that is collected annually be the CDC. There are three data sets available from the BRFSS, but the scope of this analysis is limited to one, diabetes \_ binary \_ health \_ indicators \_ BRFSS2015.csv. This is a clean data set with 253,680 responses. The variable of interest is Diabetes_binary which denotes no diabetes with 0 and pre-diabetes or diabetes with 1. There are 21 other variables included that may have relation to the variable of interest.
...
[Continue to the Modeling Writeup ](https://egshipp.github.io/Final-Project/Modeling.html)
